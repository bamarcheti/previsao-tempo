    ...
    <div className="flex flex-col rounded-lg p-7 bg-white">
      <div className="flex flex-col justify-center gap-2">
        ...
        <div className='flex items-center gap-3'>
          ...
          <button className='h-8 px-4 rounded-md text-white bg-indigo-800 font-bold hover:text-gray-400' onClick={() => { setSearch(<ResultApi valueSearch={valueSearch} />) }}>Pesquisar</button>
        </div>
        {
          (search !== '') ?
